 ...
 */
public class CreateSavedOrderService extends AbstractSavedOrderService {
    @Override
    protected ResourceState buildResourceState(Map pParam, Resource pResource) {
        System.out.println("CreateSavedOrderService buildResourceState for:" + pParam.get(KEY_ORDER_NAME));
    ...
    protected List<Link> buildLinks(Map pParam, Resource pResource) {
        System.out.println("CreateSavedOrderService buildLinks for:" + pParam.get(KEY_ORDER_NAME));
    ...
    protected Resource buildEmbeddedResource(Map pParam, Resource pResource) {
        System.out.println("CreateSavedOrderService buildEmbeddedResource for:" + pParam.get(KEY_ORDER_NAME));
        return new Resource();
    }
}
