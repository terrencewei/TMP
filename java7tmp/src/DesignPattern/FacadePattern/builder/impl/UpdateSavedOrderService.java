 ...
 */
public class UpdateSavedOrderService extends AbstractSavedOrderService {
    @Override
    protected ResourceState buildResourceState(Map pParam, Resource pResource) {
        System.out.println("UpdateSavedOrderService buildResourceState for:" + pParam.get(KEY_ORDER_NAME));
    ...
    protected List<Link> buildLinks(Map pParam, Resource pResource) {
        System.out.println("UpdateSavedOrderService buildLinks for:" + pParam.get(KEY_ORDER_NAME));
    ...
    protected Resource buildEmbeddedResource(Map pParam, Resource pResource) {
        System.out.println("UpdateSavedOrderService buildEmbeddedResource for:" + pParam.get(KEY_ORDER_NAME));
        return new Resource();
    }
}
