 ...
 * For ATG11.3.1
 */
public class generateCreateDBSQL4 {
    public static void main(String[] args) {
        // update this number when you want to create another new database schema
        System.out.println(generateSQL("_terrencewei",false));
    }
   ...
   private static String generateSQL(String pSchemaSuffix, boolean pNeedCommit){
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ACDX_EXPORT_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ACDX_EXPORT_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("\n");
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ACDX_IMPORT_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ACDX_IMPORT_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("\n");
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCATA_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCATA_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("\n");
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCATB_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCATB_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("\n");
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCORE_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGCORE_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("\n");
       ...
       // EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGPUB_ACRS_DEV1';
       sb.append("EXEC sp_addrolemember [SqlJDBCXAUser], 'ATGPUB_ACRS_DEV" + pSchemaSuffix + "';").append("\n");
       sb.append("GO").append("\n");
       if(pNeedCommit) {
           sb.append("commit;").append("\n");
       }
