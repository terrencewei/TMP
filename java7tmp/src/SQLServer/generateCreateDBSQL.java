...
public class generateCreateDBSQL {
   ...
   private static String generateSQL(int pSchemaNumber){
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER [ACDX_EXPORT_ACRS_DEV"+pSchemaNumber+"];").append("\n");
       sb.append("\n");
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER ACDX_IMPORT_ACRS_DEV"+pSchemaNumber+";").append("\n");
       sb.append("\n");
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER ATGCATA_ACRS_DEV"+pSchemaNumber+";").append("\n");
       sb.append("\n");
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER ATGCATB_ACRS_DEV"+pSchemaNumber+";").append("\n");
       sb.append("\n");
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER ATGCORE_ACRS_DEV"+pSchemaNumber+";").append("\n");
       sb.append("\n");
       ...
       sb.append("ALTER ROLE [SqlJDBCXAUser] ADD MEMBER ATGPUB_ACRS_DEV"+pSchemaNumber+";").append("\n");
       sb.append("GO").append("\n");
       sb.append("-------execute sql below----------------------").append("\n");
